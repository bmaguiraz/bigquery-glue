...
csv_file='data/salesforce/tripdata.csv'
  
csv_table=pd.read_csv(csv_file,delimiter=None)
csv_table.to_csv('data/salesforce/tripdata.csv',index=False,header=True, quoting=csv.QUOTE_ALL)
  
csv_file='data/salesforce/tripdata_2.csv'
  
csv_table=pd.read_csv(csv_file,delimiter=None)
csv_table.to_csv('data/salesforce/tripdata_2.csv',index=False,header=True, quoting=csv.QUOTE_ALL)
